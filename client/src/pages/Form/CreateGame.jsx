...
const CreateGame = () => {
    ...
    const [ newGame, setNewGame ] = useState({
        ...
        description: "",
        parent_platforms: [],
        image: "https://i0.wp.com/www.marcelopedra.com.ar/blog/wp-content/uploads/2013/10/animated-gifs-of-fighting-game-backgrounds-21.gif?resize=752%2C224&ssl=1",
        releaseDate: "",
        rating: 3.4,
        genres: []
    });
    //newGame: Es un estado local que contiene los detalles del nuevo juego que el usuario está creando,
    ...
    //es un estado local que contiene las opciones de plataformas disponibles para seleccionar.

    const [ platformSelect, setPlatformSelect ] = useState([]);//Es un estado local que contiene las plataformas seleccionadas por el usuario.
    const genres = useSelector( state => state.genresFilter );//Es un estado  contiene los géneros disponibles para los juegos.
    const [ genreSelect, setGenreSelect ] = useState([]);//Es un estado local que contiene los géneros seleccionados por el usuario.
    ...
    const handlePlatformDelete = ( evento ) => { // Elimina la plataforma del estado newGame y de platformSelect.
    ...
    // Generos
    const handleGenreSelect = ( event ) => {//Agrega el género seleccionado al estado newGame y a genreSelect.
    ...
    const handleGenreDelete = ( evento ) => { //elimina el género del estado newGame y de genreSelect.
        const value = evento.target.value;
